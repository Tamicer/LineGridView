...
public final class ViewUtils {
	 ...
	 * @return pix
	/* *//*
	public static int dip2pix(Context context, float aValue) {
		return Math.round(aValue *context.getResources().getDisplayMetrics());
	}*/
	 ...
	 * @return dip
	 *//*
	public static int pix2pix(float pix) {
		return dip2pix(pix / 1.5f); //SUPPRESS CHECKSTYLE
	}
*/
	/**
	 * pix to dip
